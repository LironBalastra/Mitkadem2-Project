...
export default function LeftBar(props) {
    return (
        ...
        <button id="addnewcontact" type="button" class="btn btn-primary float-right" onClick={AddNewContactModal}>
        ...
        <div id="newContactModal" class="modal">
            <div class="modal-content">
                ...
                <input class="form-control" id="EnterContactBox" placeholder="Contact's name" onChange={handleContactChange}/>
                <input class="btn btn-primary" type="button" value="Add" onClick={() => AddContact(props.user,props.users , props.setcontactList)}></input>
            </div>
        </div>
        </div>
